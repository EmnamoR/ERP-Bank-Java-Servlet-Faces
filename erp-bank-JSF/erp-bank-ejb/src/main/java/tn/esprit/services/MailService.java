...
public class MailService {
	    ...
	    private static final String USER = "emna.amor@esprit.tn";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
	    private static final String PASSWORD = "fok3aza7i"; // Must be valid password for smit0012
	    private static final String FROM = "ERP-BANK <emna.amor@esprit.tn>";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
	}
